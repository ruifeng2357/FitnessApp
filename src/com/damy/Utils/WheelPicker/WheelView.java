...
package com.damy.Utils.WheelPicker;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF00a086; //0xF0000000;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF868686; //0xFF000000;
...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	private static int ADDITIONAL_ITEM_HEIGHT = 45;
	private static int ADDITIONAL_ITEM_HEIGHT_ORIGIN = 45;
...
//		setBackgroundResource(R.drawable.wheel_bg);
	...
	public void drawBorders(Canvas canvas)
	{
		...
		borderPaint.setColor(Color.rgb(134, 134, 134));
		borderPaint.setStyle(Paint.Style.STROKE);

		canvas.drawRect(0, 0, WheelView.this.getWidth() - 1, WheelView.this.getHeight() - 1, borderPaint);
		*/
	}
	
	// added by kimilmi
	public static void setAdditionalItemHeightwithResolution(float nVal)
	{
		float newVal = (float)ADDITIONAL_ITEM_HEIGHT_ORIGIN * (float)nVal + (float)0.50001;
		ADDITIONAL_ITEM_HEIGHT = (int)newVal;
	}
