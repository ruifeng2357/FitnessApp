...
public class AlarmAlertFullScreen extends Activity {
    ...
    private void setTime() {
        ...
        TextView time = (TextView) findViewById(R.id.alertTime);
        String label = String.format("%02d:%02d", curDate.getHours(), curDate.getMinutes());
        time.setText(label);
    }
    ...
    private void updateLayout() {
        ...
        ResolutionSet1._instance.iterateChild(findViewById(R.id.rl_alarmalert));
    ...
    private void snooze() {
        ...
        final String snooze = DEFAULT_SNOOZE;   //kimilmi snooze
