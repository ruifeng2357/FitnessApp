...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.damy.jiankang.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.damy.jiankang.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.damy.jiankang.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.damy.jiankang.ALARM_DISMISS";
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(AlarmActivity.PREFERENCES, 0);
