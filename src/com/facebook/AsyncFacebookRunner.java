...
public class AsyncFacebookRunner {
    ...
    public void request1(Bundle parameters, RequestListener listener) {
        request(null, parameters, "POST", listener, /* state */ null);
    }
    /**
    ...
    public void request1(String graphPath,
            Bundle parameters,
            RequestListener listener) {
request(graphPath, parameters, "POST", listener, /* state */ null);
}
    /**
