...
public class Facebook {
	...
	private static final int DEFAULT_AUTH_ACTIVITY_CODE = 0;
	...
	public void authorize(Activity activity, String[] permissions,
		...
		Log.v("FB", "other authorize method");
	...
	public void authorize(Activity activity, String[] permissions,
		...
		Log.v("FACEBOOK", "singleSignOnStarted :: " + singleSignOnStarted);
	...
	private void startDialogAuth(Activity activity, String[] permissions) {
		...
		Log.v("FB", "startDialogAuth :: " + permissions);
		...
		dialog(activity, LOGIN, params, new DialogListener() {
			...
			public void onComplete(Bundle values) {
				...
				Log.v("FB", "DialogListener ::  onComplete " + values);
				...
				if (isSessionValid()) {
					...
					Log.v("FB", "DialogListener ::  session valid");

					Log.d("Facebook-authorize", "Login Success! access_token="
							+ getAccessToken() + " expires="
							+ getAccessExpires());
					Global.FB_access_token = getAccessToken();
					mAuthDialogListener.onComplete(values);
				} else {
					Log.v("FB", "DialogListener ::  session invalid");
	...
	public void dialog(Context context, String action, Bundle parameters,
		...
		if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
			...
			FbDialog fbDia = new FbDialog(context, url, listener);
			fbDia.getWindow().setSoftInputMode(
